...
return [
     ...
     */
    'projectors' => [
        App\Projectors\TaskProjector::class,
        App\Projectors\StatisticsProjector::class,
        App\Projectors\MilestoneProjector::class,
        //App\Projectors\HistoryProjector::class,
        App\Projectors\TaskListProjector::class,
    ],
     ...
     */
    'reactors' => [
        App\Reactors\MilestoneReactor::class,
    ],
